...
constexpr double kTargetSpeedMps = 1.25;
constexpr double kMaximumLateralAccelerationMps2 = 1.00;
constexpr double kReferenceMaximumCurvatureInvM = 1.805109423516146;
constexpr double kPeakCurvatureWeight = 0.02;
constexpr double kCurvatureEpsilonInvM = 1.0e-9;

}  // namespace

double lap_time_qualifying_transition(
...
double lap_time_qualifying_heuristic(double minimum_distance_m) noexcept
{
