...
constexpr double kTargetSpeedMps = 1.05;
constexpr double kMaximumLateralAccelerationMps2 = 0.80;
constexpr double kReferenceMaximumCurvatureInvM = 1.805109423516146;
constexpr double kPeakCurvatureWeight = 0.08;
constexpr double kCurvatureEpsilonInvM = 1.0e-9;

}  // namespace

double lap_time_fast_transition(
...
double lap_time_fast_heuristic(double minimum_distance_m) noexcept
{
